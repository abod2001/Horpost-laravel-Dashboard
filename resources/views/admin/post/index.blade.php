            ...
            <div class="card-body">
                ...
                <div class="data-organization" style="margin-bottom: 30px">
                    <div class="text-right " style="margin-bottom: 30px">
                        <a style="font-size: 20px"><i class="fas fa-bookmark ml-2"></i>عرض الأخبار :</a>
                    </div>
                </div>
                <table class="table table-bordered table-striped text-right" style="font-size: 18px;width: 1000px;" id="posts_table">
                    <thead>
                    <tr>
                        ...
                        <th class="text-center h-bordertop" scope="col">القسم</th>
            ...
            $('table').on('click','.edit_btn',function (){
                ...
                $.ajax({
                    ...
                    success: function (data){
                        ...
                        modal.find('select[name=section_id]').val(data.section_id);
                        modal.modal('show');
                    },
                    error:function (err){
